...
type BidRequest struct {
	...
	At *AuctionType `protobuf:"varint,7,opt,name=at,enum=AuctionType,def=2" json:"at,omitempty"`
...
type BidResponse struct {
	...
	Nbr *NoBidReason `protobuf:"varint,6,opt,name=nbr,enum=NoBidReason" json:"nbr,omitempty"`
}
...
type NativeRequest struct {
	...
	Layout *LayoutId `protobuf:"varint,2,opt,name=layout,enum=LayoutId" json:"layout,omitempty"`
	// The Ad unit ID of the native ad unit.
	// This corresponds to one of IAB Core-6 native ad units.
	// RECOMMENDED by OpenRTB Native 1.0; optional in 1.1, DEPRECATED in 1.2.
	Adunit *AdUnitId `protobuf:"varint,3,opt,name=adunit,enum=AdUnitId" json:"adunit,omitempty"`
	// The context in which the ad appears.
	// RECOMMENDED in 1.2.
	Context *ContextType `protobuf:"varint,7,opt,name=context,enum=ContextType" json:"context,omitempty"`
	// A more detailed context in which the ad appears.
	Contextsubtype *ContextSubtype `protobuf:"varint,8,opt,name=contextsubtype,enum=ContextSubtype" json:"contextsubtype,omitempty"`
	// The design/format/layout of the ad unit being offered.
	// RECOMMENDED by the OpenRTB Native specification.
	Plcmttype *PlacementType `protobuf:"varint,9,opt,name=plcmttype,enum=PlacementType" json:"plcmttype,omitempty"`
...
type BidRequest_Content struct {
	...
	// Production quality.
	Prodq *ProductionQuality `protobuf:"varint,25,opt,name=prodq,enum=ProductionQuality" json:"prodq,omitempty"`
	// NOTE: Deprecated in favor of prodq.
	// Video quality per IAB's classification.
	//
	// Deprecated: Do not use.
	Videoquality *ProductionQuality `protobuf:"varint,8,opt,name=videoquality,enum=ProductionQuality" json:"videoquality,omitempty"`
	...
	Context *ContentContext `protobuf:"varint,20,opt,name=context,enum=ContentContext" json:"context,omitempty"`
	...
	Qagmediarating *QAGMediaRating `protobuf:"varint,17,opt,name=qagmediarating,enum=QAGMediaRating" json:"qagmediarating,omitempty"`
...
type BidRequest_Device struct {
	...
	Connectiontype *ConnectionType `protobuf:"varint,17,opt,name=connectiontype,enum=ConnectionType" json:"connectiontype,omitempty"`
	// The general type of device.
	Devicetype *DeviceType `protobuf:"varint,18,opt,name=devicetype,enum=DeviceType" json:"devicetype,omitempty"`
...
type BidRequest_Geo struct {
	...
	Type *LocationType `protobuf:"varint,9,opt,name=type,enum=LocationType" json:"type,omitempty"`
	...
	Ipservice *LocationService `protobuf:"varint,13,opt,name=ipservice,enum=LocationService" json:"ipservice,omitempty"`
...
type BidRequest_Imp_Banner struct {
	...
	Pos *AdPosition `protobuf:"varint,4,opt,name=pos,enum=AdPosition" json:"pos,omitempty"`
	// Blocked banner ad types.
	Btype []BannerAdType `protobuf:"varint,5,rep,packed,name=btype,enum=BannerAdType" json:"btype,omitempty"`
	// Blocked creative attributes.
	Battr []CreativeAttribute `protobuf:"varint,6,rep,packed,name=battr,enum=CreativeAttribute" json:"battr,omitempty"`
	...
	Expdir []ExpandableDirection `protobuf:"varint,9,rep,packed,name=expdir,enum=ExpandableDirection" json:"expdir,omitempty"`
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api []APIFramework `protobuf:"varint,10,rep,packed,name=api,enum=APIFramework" json:"api,omitempty"`
...
type BidRequest_Imp_Video struct {
	...
	Linearity *VideoLinearity `protobuf:"varint,2,opt,name=linearity,enum=VideoLinearity" json:"linearity,omitempty"`
	...
	Protocols []Protocol `protobuf:"varint,21,rep,packed,name=protocols,enum=Protocol" json:"protocols,omitempty"`
	...
	// Blocked creative attributes.
	Battr []CreativeAttribute `protobuf:"varint,10,rep,packed,name=battr,enum=CreativeAttribute" json:"battr,omitempty"`
	...
	Playbackmethod []PlaybackMethod `protobuf:"varint,15,rep,packed,name=playbackmethod,enum=PlaybackMethod" json:"playbackmethod,omitempty"`
	// Supported delivery methods (e.g., streaming, progressive).
	// If none specified, assume all are supported.
	Delivery []ContentDeliveryMethod `protobuf:"varint,16,rep,packed,name=delivery,enum=ContentDeliveryMethod" json:"delivery,omitempty"`
	// Ad position on screen.
	Pos *AdPosition `protobuf:"varint,17,opt,name=pos,enum=AdPosition" json:"pos,omitempty"`
	...
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api []APIFramework `protobuf:"varint,19,rep,packed,name=api,enum=APIFramework" json:"api,omitempty"`
	// Supported VAST companion ad types.  Recommended if companion Banner
	// objects are included via the companionad array.
	Companiontype []CompanionType `protobuf:"varint,20,rep,packed,name=companiontype,enum=CompanionType" json:"companiontype,omitempty"`
	// Placement type for the impression.
	Placement *VideoPlacementType `protobuf:"varint,26,opt,name=placement,enum=VideoPlacementType" json:"placement,omitempty"`
	// The event that causes playback to end.
	Playbackend *PlaybackCessationMode `protobuf:"varint,27,opt,name=playbackend,enum=PlaybackCessationMode" json:"playbackend,omitempty"`
}
...
type BidRequest_Imp_Audio struct {
	...
	// RECOMMENDED by the OpenRTB specification.
	Protocols []Protocol `protobuf:"varint,4,rep,packed,name=protocols,enum=Protocol" json:"protocols,omitempty"`
	// Indicates the start delay in seconds for pre-roll, mid-roll, or
	// post-roll ad placements.
	// Refer to enum StartDelay for generic values.
	// RECOMMENDED by the OpenRTB specification.
	...
	// Blocked creative attributes.
	Battr []CreativeAttribute `protobuf:"varint,7,rep,packed,name=battr,enum=CreativeAttribute" json:"battr,omitempty"`
	// Maximum extended video ad duration, if extension is allowed.
	// If blank or 0, extension is not allowed. If -1, extension is allowed,
	// and there is no time limit imposed. If greater than 0, then the value
	// represents the number of seconds of extended play supported beyond
	...
	// Supported delivery methods (e.g., streaming, progressive).
	// If none specified, assume all are supported.
	Delivery []ContentDeliveryMethod `protobuf:"varint,11,rep,packed,name=delivery,enum=ContentDeliveryMethod" json:"delivery,omitempty"`
	// Array of Banner objects if companion ads are available.
	Companionad []*BidRequest_Imp_Banner `protobuf:"bytes,12,rep,name=companionad" json:"companionad,omitempty"`
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api []APIFramework `protobuf:"varint,13,rep,packed,name=api,enum=APIFramework" json:"api,omitempty"`
	...
	// Type of audio feed.
	Feed *FeedType `protobuf:"varint,22,opt,name=feed,enum=FeedType" json:"feed,omitempty"`
	...
	Nvol *VolumeNormalizationMode `protobuf:"varint,24,opt,name=nvol,enum=VolumeNormalizationMode" json:"nvol,omitempty"`
}
...
type BidRequest_Imp_Native struct {
	...
	// List of supported API frameworks for this impression.
	// If an API is not explicitly listed, it is assumed not to be supported.
	Api []APIFramework `protobuf:"varint,3,rep,packed,name=api,enum=APIFramework" json:"api,omitempty"`
	// Blocked creative attributes.
	Battr []CreativeAttribute `protobuf:"varint,4,rep,packed,name=battr,enum=CreativeAttribute" json:"battr,omitempty"`
}
...
type BidRequest_Imp_Pmp_Deal struct {
	...
	At *AuctionType `protobuf:"varint,6,opt,name=at,enum=AuctionType" json:"at,omitempty"`
}
...
type BidResponse_SeatBid_Bid struct {
	...
	Attr []CreativeAttribute `protobuf:"varint,11,rep,packed,name=attr,enum=CreativeAttribute" json:"attr,omitempty"`
	// API required by the markup if applicable.
	Api *APIFramework `protobuf:"varint,18,opt,name=api,enum=APIFramework" json:"api,omitempty"`
	// Video response protocol of the markup if applicable.
	Protocol *Protocol `protobuf:"varint,19,opt,name=protocol,enum=Protocol" json:"protocol,omitempty"`
	// Creative media rating per QAG guidelines.
	Qagmediarating *QAGMediaRating `protobuf:"varint,20,opt,name=qagmediarating,enum=QAGMediaRating" json:"qagmediarating,omitempty"`
...
type NativeRequest_EventTrackers struct {
	...
	// REQUIRED by the OpenRTB Native specification.
	Event *EventType `protobuf:"varint,1,req,name=event,enum=EventType" json:"event,omitempty"`
	// Array of types of tracking available for the given event.
	// REQUIRED by the OpenRTB Native specification.
	Methods []EventTrackingMethod `protobuf:"varint,2,rep,name=methods,enum=EventTrackingMethod" json:"methods,omitempty"`
}
...
type NativeRequest_Asset_Image struct {
	...
	Type *ImageAssetType `protobuf:"varint,1,opt,name=type,enum=ImageAssetType" json:"type,omitempty"`
...
type NativeRequest_Asset_Data struct {
	...
	// REQUIRED by the OpenRTB Native specification.
	Type *DataAssetType `protobuf:"varint,1,req,name=type,enum=DataAssetType" json:"type,omitempty"`
...
type NativeResponse_EventTracker struct {
	...
	// REQUIRED if embedded asset is being used.
	Method *EventTrackingMethod `protobuf:"varint,2,req,name=method,enum=EventTrackingMethod" json:"method,omitempty"`
...
type NativeResponse_Asset_Image struct {
	...
	// Implemented in 1.2
	Type *ImageAssetType `protobuf:"varint,4,opt,name=type,enum=ImageAssetType" json:"type,omitempty"`
...
type NativeResponse_Asset_Data struct {
	...
	// Implemented in 1.2.
	Type *DataAssetType `protobuf:"varint,3,opt,name=type,enum=DataAssetType" json:"type,omitempty"`
...
var file_openrtb_proto_rawDesc = []byte{
	,
	...
	,
	...
	,
	...
	,
	...
	0x66, 0x72, 0x61, 0x6d, 0x65, 0x12, 0x30, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x64, 0x69, 0x72, 0x18,
	0x09, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x45, 0x78, 0x70, 0x61, 0x6e, 0x64, 0x61, 0x62,
	0x6c, 0x65, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x02, 0x10, 0x01, 0x52,
	0x06, 0x65, 0x78, 0x70, 0x64, 0x69, 0x72, 0x12, 0x23, 0x0a, 0x03, 0x61, 0x70, 0x69, 0x18, 0x0a,
	0x20, 0x03, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x41, 0x50, 0x49, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x77,
	...
	,
	...
	,
	...
	0x64, 0x12, 0x36, 0x0a, 0x08, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0
 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x22, 0x0a, 0x04,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x44, 0x61, 0x74,
	0x61, 0x41, 0x73, 0x73, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x12, 0x10, 0x0a, 0x03, 0x6c, 0x65, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x6c,
	...
	0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x1a, 0x77, 0x0a, 0x0c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x72,
	0x61, 0x63, 0x6b, 0x65, 0x72, 0x12, 0x20, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
	0x52, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x2c, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f,
	0x64, 0x18, 0x02, 0x20, 0x02, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54,
	...
	0x0a, 0x02, 0x4a, 0x53, 0x10, 0x02, 0x42, 0x19, 0x5a, 0x17, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_openrtb_proto_goTypes = []interface{}{
	(ContentCategory)(0),                     // 0: ContentCategory
	(AuctionType)(0),                         // 1: AuctionType
	(BannerAdType)(0),                        // 2: BannerAdType
	(CreativeAttribute)(0),                   // 3: CreativeAttribute
	(APIFramework)(0),                        // 4: APIFramework
	(AdPosition)(0),                          // 5: AdPosition
	(VideoLinearity)(0),                      // 6: VideoLinearity
	(Protocol)(0),                            // 7: Protocol
	(PlaybackMethod)(0),                      // 8: PlaybackMethod
	(StartDelay)(0),                          // 9: StartDelay
	(VideoPlacementType)(0),                  // 10: VideoPlacementType
	(PlaybackCessationMode)(0),               // 11: PlaybackCessationMode
	(ConnectionType)(0),                      // 12: ConnectionType
	(ExpandableDirection)(0),                 // 13: ExpandableDirection
	(ContentDeliveryMethod)(0),               // 14: ContentDeliveryMethod
	(ContentContext)(0),                      // 15: ContentContext
	(ProductionQuality)(0),                   // 16: ProductionQuality
	(LocationType)(0),                        // 17: LocationType
	(LocationService)(0),                     // 18: LocationService
	(DeviceType)(0),                          // 19: DeviceType
	(CompanionType)(0),                       // 20: CompanionType
	(QAGMediaRating)(0),                      // 21: QAGMediaRating
	(NoBidReason)(0),                         // 22: NoBidReason
	(LossReason)(0),                          // 23: LossReason
	(FeedType)(0),                            // 24: FeedType
	(VolumeNormalizationMode)(0),             // 25: VolumeNormalizationMode
	(LayoutId)(0),                            // 26: LayoutId
	(AdUnitId)(0),                            // 27: AdUnitId
	(ContextType)(0),                         // 28: ContextType
	(ContextSubtype)(0),                      // 29: ContextSubtype
	(PlacementType)(0),                       // 30: PlacementType
	(DataAssetType)(0),                       // 31: DataAssetType
	(ImageAssetType)(0),                      // 32: ImageAssetType
	(EventType)(0),                           // 33: EventType
	(EventTrackingMethod)(0),                 // 34: EventTrackingMethod
	(*BidRequest)(nil),                       // 35: BidRequest
	(*BidResponse)(nil),                      // 36: BidResponse
	(*NativeRequest)(nil),                    // 37: NativeRequest
	(*NativeResponse)(nil),                   // 38: NativeResponse
	(*BidRequest_Source)(nil),                // 39: BidRequest.Source
	(*BidRequest_Imp)(nil),                   // 40: BidRequest.Imp
	(*BidRequest_Site)(nil),                  // 41: BidRequest.Site
	(*BidRequest_App)(nil),                   // 42: BidRequest.App
	(*BidRequest_Publisher)(nil),             // 43: BidRequest.Publisher
	(*BidRequest_Content)(nil),               // 44: BidRequest.Content
	(*BidRequest_Producer)(nil),              // 45: BidRequest.Producer
	(*BidRequest_Device)(nil),                // 46: BidRequest.Device
	(*BidRequest_Geo)(nil),                   // 47: BidRequest.Geo
	(*BidRequest_User)(nil),                  // 48: BidRequest.User
	(*BidRequest_Data)(nil),                  // 49: BidRequest.Data
	(*BidRequest_Regs)(nil),                  // 50: BidRequest.Regs
	(*BidRequest_Imp_Metric)(nil),            // 51: BidRequest.Imp.Metric
	(*BidRequest_Imp_Banner)(nil),            // 52: BidRequest.Imp.Banner
	(*BidRequest_Imp_Video)(nil),             // 53: BidRequest.Imp.Video
	(*BidRequest_Imp_Audio)(nil),             // 54: BidRequest.Imp.Audio
	(*BidRequest_Imp_Native)(nil),            // 55: BidRequest.Imp.Native
	(*BidRequest_Imp_Pmp)(nil),               // 56: BidRequest.Imp.Pmp
	(*BidRequest_Imp_Banner_Format)(nil),     // 57: BidRequest.Imp.Banner.Format
	(*BidRequest_Imp_Video_CompanionAd)(nil), // 58: BidRequest.Imp.Video.CompanionAd
	(*BidRequest_Imp_Pmp_Deal)(nil),          // 59: BidRequest.Imp.Pmp.Deal
	(*BidRequest_Data_Segment)(nil),          // 60: BidRequest.Data.Segment
	(*BidResponse_SeatBid)(nil),              // 61: BidResponse.SeatBid
	(*BidResponse_SeatBid_Bid)(nil),          // 62: BidResponse.SeatBid.Bid
	(*NativeRequest_Asset)(nil),              // 63: NativeRequest.Asset
	(*NativeRequest_EventTrackers)(nil),      // 64: NativeRequest.EventTrackers
	(*NativeRequest_Asset_Title)(nil),        // 65: NativeRequest.Asset.Title
	(*NativeRequest_Asset_Image)(nil),        // 66: NativeRequest.Asset.Image
	(*NativeRequest_Asset_Data)(nil),         // 67: NativeRequest.Asset.Data
	(*NativeResponse_Link)(nil),              // 68: NativeResponse.Link
	(*NativeResponse_Asset)(nil),             // 69: NativeResponse.Asset
	(*NativeResponse_EventTracker)(nil),      // 70: NativeResponse.EventTracker
	(*NativeResponse_Asset_Title)(nil),       // 71: NativeResponse.Asset.Title
	(*NativeResponse_Asset_Image)(nil),       // 72: NativeResponse.Asset.Image
	(*NativeResponse_Asset_Data)(nil),        // 73: NativeResponse.Asset.Data
	(*NativeResponse_Asset_Video)(nil),       // 74: NativeResponse.Asset.Video
}
var file_openrtb_proto_depIdxs = []int32{
	40, // 0: BidRequest.imp:type_name -> BidRequest.Imp
	41, // 1: BidRequest.site:type_name -> BidRequest.Site
	42, // 2: BidRequest.app:type_name -> BidRequest.App
	46, // 3: BidRequest.device:type_name -> BidRequest.Device
	50, // 4: BidRequest.regs:type_name -> BidRequest.Regs
	48, // 5: BidRequest.user:type_name -> BidRequest.User
	1,  // 6: BidRequest.at:type_name -> AuctionType
	39, // 7: BidRequest.source:type_name -> BidRequest.Source
	61, // 8: BidResponse.seatbid:type_name -> BidResponse.SeatBid
	22, // 9: BidResponse.nbr:type_name -> NoBidReason
	26, // 10: NativeRequest.layout:type_name -> LayoutId
	27, // 11: NativeRequest.adunit:type_name -> AdUnitId
	28, // 12: NativeRequest.context:type_name -> ContextType
	29, // 13: NativeRequest.contextsubtype:type_name -> ContextSubtype
	30, // 14: NativeRequest.plcmttype:type_name -> PlacementType
	63, // 15: NativeRequest.assets:type_name -> NativeRequest.Asset
	64, // 16: NativeRequest.eventtrackers:type_name -> NativeRequest.EventTrackers
	69, // 17: NativeResponse.assets:type_name -> NativeResponse.Asset
	68, // 18: NativeResponse.link:type_name -> NativeResponse.Link
	70, // 19: NativeResponse.eventtrackers:type_name -> NativeResponse.EventTracker
	52, // 20: BidRequest.Imp.banner:type_name -> BidRequest.Imp.Banner
	53, // 21: BidRequest.Imp.video:type_name -> BidRequest.Imp.Video
	54, // 22: BidRequest.Imp.audio:type_name -> BidRequest.Imp.Audio
	56, // 23: BidRequest.Imp.pmp:type_name -> BidRequest.Imp.Pmp
	55, // 24: BidRequest.Imp.native:type_name -> BidRequest.Imp.Native
	51, // 25: BidRequest.Imp.metric:type_name -> BidRequest.Imp.Metric
	43, // 26: BidRequest.Site.publisher:type_name -> BidRequest.Publisher
	44, // 27: BidRequest.Site.content:type_name -> BidRequest.Content
	43, // 28: BidRequest.App.publisher:type_name -> BidRequest.Publisher
	44, // 29: BidRequest.App.content:type_name -> BidRequest.Content
	16, // 30: BidRequest.Content.prodq:type_name -> ProductionQuality
	16, // 31: BidRequest.Content.videoquality:type_name -> ProductionQuality
	15, // 32: BidRequest.Content.context:type_name -> ContentContext
	45, // 33: BidRequest.Content.producer:type_name -> BidRequest.Producer
	21, // 34: BidRequest.Content.qagmediarating:type_name -> QAGMediaRating
	47, // 35: BidRequest.Device.geo:type_name -> BidRequest.Geo
	12, // 36: BidRequest.Device.connectiontype:type_name -> ConnectionType
	19, // 37: BidRequest.Device.devicetype:type_name -> DeviceType
	17, // 38: BidRequest.Geo.type:type_name -> LocationType
	18, // 39: BidRequest.Geo.ipservice:type_name -> LocationService
	47, // 40: BidRequest.User.geo:type_name -> BidRequest.Geo
	49, // 41: BidRequest.User.data:type_name -> BidRequest.Data
	60, // 42: BidRequest.Data.segment:type_name -> BidRequest.Data.Segment
	57, // 43: BidRequest.Imp.Banner.format:type_name -> BidRequest.Imp.Banner.Format
	5,  // 44: BidRequest.Imp.Banner.pos:type_name -> AdPosition
	2,  // 45: BidRequest.Imp.Banner.btype:type_name -> BannerAdType
	3,  // 46: BidRequest.Imp.Banner.battr:type_name -> CreativeAttribute
	13, // 47: BidRequest.Imp.Banner.expdir:type_name -> ExpandableDirection
	4,  // 48: BidRequest.Imp.Banner.api:type_name -> APIFramework
	6,  // 49: BidRequest.Imp.Video.linearity:type_name -> VideoLinearity
	7,  // 50: BidRequest.Imp.Video.protocol:type_name -> Protocol
	7,  // 51: BidRequest.Imp.Video.protocols:type_name -> Protocol
	3,  // 52: BidRequest.Imp.Video.battr:type_name -> CreativeAttribute
	8,  // 53: BidRequest.Imp.Video.playbackmethod:type_name -> PlaybackMethod
	14, // 54: BidRequest.Imp.Video.delivery:type_name -> ContentDeliveryMethod
	5,  // 55: BidRequest.Imp.Video.pos:type_name -> AdPosition
	52, // 56: BidRequest.Imp.Video.companionad:type_name -> BidRequest.Imp.Banner
	58, // 57: BidRequest.Imp.Video.companionad_21:type_name -> BidRequest.Imp.Video.CompanionAd
	4,  // 58: BidRequest.Imp.Video.api:type_name -> APIFramework
	20, // 59: BidRequest.Imp.Video.companiontype:type_name -> CompanionType
	10, // 60: BidRequest.Imp.Video.placement:type_name -> VideoPlacementType
	11, // 61: BidRequest.Imp.Video.playbackend:type_name -> PlaybackCessationMode
	7,  // 62: BidRequest.Imp.Audio.protocols:type_name -> Protocol
	3,  // 63: BidRequest.Imp.Audio.battr:type_name -> CreativeAttribute
	14, // 64: BidRequest.Imp.Audio.delivery:type_name -> ContentDeliveryMethod
	52, // 65: BidRequest.Imp.Audio.companionad:type_name -> BidRequest.Imp.Banner
	4,  // 66: BidRequest.Imp.Audio.api:type_name -> APIFramework
	20, // 67: BidRequest.Imp.Audio.companiontype:type_name -> CompanionType
	24, // 68: BidRequest.Imp.Audio.feed:type_name -> FeedType
	25, // 69: BidRequest.Imp.Audio.nvol:type_name -> VolumeNormalizationMode
	37, // 70: BidRequest.Imp.Native.request_native:type_name -> NativeRequest
	4,  // 71: BidRequest.Imp.Native.api:type_name -> APIFramework
	3,  // 72: BidRequest.Imp.Native.battr:type_name -> CreativeAttribute
	59, // 73: BidRequest.Imp.Pmp.deals:type_name -> BidRequest.Imp.Pmp.Deal
	52, // 74: BidRequest.Imp.Video.CompanionAd.banner:type_name -> BidRequest.Imp.Banner
	1,  // 75: BidRequest.Imp.Pmp.Deal.at:type_name -> AuctionType
	62, // 76: BidResponse.SeatBid.bid:type_name -> BidResponse.SeatBid.Bid
	38, // 77: BidResponse.SeatBid.Bid.adm_native:type_name -> NativeResponse
	3,  // 78: BidResponse.SeatBid.Bid.attr:type_name -> CreativeAttribute
	4,  // 79: BidResponse.SeatBid.Bid.api:type_name -> APIFramework
	7,  // 80: BidResponse.SeatBid.Bid.protocol:type_name -> Protocol
	21, // 81: BidResponse.SeatBid.Bid.qagmediarating:type_name -> QAGMediaRating
	65, // 82: NativeRequest.Asset.title:type_name -> NativeRequest.Asset.Title
	66, // 83: NativeRequest.Asset.img:type_name -> NativeRequest.Asset.Image
	53, // 84: NativeRequest.Asset.video:type_name -> BidRequest.Imp.Video
	67, // 85: NativeRequest.Asset.data:type_name -> NativeRequest.Asset.Data
	33, // 86: NativeRequest.EventTrackers.event:type_name -> EventType
	34, // 87: NativeRequest.EventTrackers.methods:type_name -> EventTrackingMethod
	32, // 88: NativeRequest.Asset.Image.type:type_name -> ImageAssetType
	31, // 89: NativeRequest.Asset.Data.type:type_name -> DataAssetType
	71, // 90: NativeResponse.Asset.title:type_name -> NativeResponse.Asset.Title
	72, // 91: NativeResponse.Asset.img:type_name -> NativeResponse.Asset.Image
	74, // 92: NativeResponse.Asset.video:type_name -> NativeResponse.Asset.Video
	73, // 93: NativeResponse.Asset.data:type_name -> NativeResponse.Asset.Data
	68, // 94: NativeResponse.Asset.link:type_name -> NativeResponse.Link
	33, // 95: NativeResponse.EventTracker.event:type_name -> EventType
	34, // 96: NativeResponse.EventTracker.method:type_name -> EventTrackingMethod
	32, // 97: NativeResponse.Asset.Image.type:type_name -> ImageAssetType
	31, // 98: NativeResponse.Asset.Data.type:type_name -> DataAssetType
